...
import org.cyb.training.java.rs.v5.service.DefaultUserService;
import org.cyb.training.java.rs.v5.service.IUserService;
import org.cyb.training.java.rs.v5.view.UserView;
...
public class UserResource {
	...
	public Response getUser(@PathParam("id") int userId) throws CoreServiceException{
		System.out.println("Has hit the server to get user..");
